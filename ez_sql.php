<?php
	...
	define("EZSQL_DB_USER", $username_fp_mysql);			// <-- mysql db user
	define("EZSQL_DB_PASSWORD", $password_fp_mysql);		// <-- mysql db password
	define("EZSQL_DB_NAME", $database_fp_mysql);		// <-- mysql db pname
	define("EZSQL_DB_HOST", $hostname_fp_mysql);	// <-- mysql server host
	...
	class db {
		...
		function print_error($str = "")
		{
			...
			if ( $this->show_errors )
			{
				...
				print "<blockquote><font face=arial size=2 color=ff6633>";
				print "<b>SQL/DB Error --</b> ";
				print "[<font color=ffcc66>$str</font>]";
