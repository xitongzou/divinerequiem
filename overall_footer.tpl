...
<TABLE WIDTH=100% BORDER=0 CELLPADDING=0 CELLSPACING=0>
	...
	<TR>
		...
		<font class="copyright">{ADMIN_LINK}<br>Powered by <a href="http://www.phpbb.com/" target="_phpbb" class="copyright">phpBB</a> {PHPBB_VERSION} &copy; 2001, 2002 phpBB Group<br />{PAGE_INFO_MOD}<br></font>
		</TD>
	</TR>
	<TR>
		<TD>
